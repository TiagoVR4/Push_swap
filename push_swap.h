...
/*   Updated: 2025/03/26 12:17:23 by tiagalex         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	select_rotation(t_node **stack_a, t_node **stack_b,
			int min, char flag);
void	combine_rotations(t_node **stack_a,
			t_node **stack_b, int rot_a, int rot_b);
void	complete_rotations(t_node **stack_a,
			t_node **stack_b, int rot_a, int rot_b);
